...
def test_clean_db(mock_db):
    ...
    mock_db.execute_query(
        "INSERT INTO news_inviate (id_news,time_stamp) VALUES (?,?)",
        (id_da_eliminare, data_finta.strftime("%Y-%m-%d %H:%M:%S")),
    )
